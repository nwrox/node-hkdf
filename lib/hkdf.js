...
function hkdfBufferGenerator(hashAlg, ikm, info, salt, outLen) {
  ...
  if(n >= 256) throw Error('HKDF cannot generate more than 255 blocks of HashLen size');
  if (outLen > 255 * hashLen) throw Error('HKDF may only be used for 255 * HashLen bytes of output');
